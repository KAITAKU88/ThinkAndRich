...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        "fixed left-1/2 top-1/2 z-50 grid w-[calc(100%-1.5rem)] max-w-md max-h-[calc(100dvh-1.5rem)] -translate-x-1/2 -translate-y-1/2 gap-4 overflow-y-auto border border-border bg-card p-4 shadow-lg duration-200 rounded-xl sm:w-full sm:max-h-none sm:overflow-visible sm:p-6",
        className
      )}
      {...props}
    >
