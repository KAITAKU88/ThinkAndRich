/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 49078b5a25b2c01a94f8c9b9be338079)
...
interface __BaseEnv_CloudflareEnv {
	...
	EMAIL: SendEmail;
	ASSETS: Fetcher;
	ADMIN_HOST: "admin.thinkandrich.ankiva.cc";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ADMIN_HOST" | "SESSION_COOKIE_DOMAIN" | "JWT_SECRET" | "SEPAY_WEBHOOK_SECRET" | "LEMONSQUEEZY_API_KEY" | "LEMONSQUEEZY_STORE_ID" | "LEMONSQUEEZY_VARIANT_PLUS" | "LEMONSQUEEZY_VARIANT_PRO" | "LEMONSQUEEZY_WEBHOOK_SECRET" | "ADMIN_EMAILS">> {}
}
